export const features = [
  {
    ...
    id: "0",
    url:"https://ai-chat-bot-pratham.vercel.app/",
    icon: "/images/feature-1.png",
    caption: "Project 1",
    title: "AI Chat Bot ",
    text: "A chatbot powered by the Gemini AI API from Google. Users can engage in conversations and receive high-quality, AI-generated responses.",
    button: {
  ...
  {
    id: "1",
    url:"https://ai-object-detector-pratham.vercel.app/",
    icon: "/images/feature-2.png",
    caption: "Project 2",
    title: "Object Detector",
    text: "AI-powered object detector for real-time webcam tracking. Detects persons, objects, and other elements quickly with enhanced accuracy and performance.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Visit Demo",
    },
  ...
  {
    id: "2",
    url:"https://notes-maker-pratham.vercel.app/",
    icon: "/images/feature-2.png",
    caption: "Project 3",
    title: "Notes Maker",
    text: "A Notes Maker web application for managing notes: create, edit, delete, and organize notes with tags. Includes a powerful search feature to quickly find and retrieve your saved notes.",
    button: {
      icon: "/images/magictouch.svg",
      title: "Visit Demo",
    },
  ...
  {
    id: "3",
    url:"https://brick-breaker-pratham.vercel.app/",
    icon: "/images/feature-2.png",
    caption: "Project 4",
    title: "Brick Breaker",
    text: " This project features a controlling a paddle to bounce a ball and break rows of colorful bricks. The game features smooth animations and engaging gameplay,",
    button: {
      icon: "/images/magictouch.svg",
      title: "Visit Demo",
...
export const faq = [
  {
    ...
    question: "Class X",
    answer:
      "92.8% | 2019 | CBSE | Olympus High School",
  },
  {
    id: "1",
    question: "Class XII",
    answer:
      "86.4% | 2021 | CBSE | Olympus High School",
  },
  {
    id: "2",
    question: "Btech CSE",
    answer:
      "7.5 CGPA | 2021-2025 | DIT University",
  },
  {
    id: "3",
    question: "What services do you offer?",
    answer:
      "I offer a range of creative services including web development, web design, branding, digital marketing, and content creation.",
  },
  {
    id: "4",
    question: "What is your design process?",
    answer:
      "My design process starts with understanding your needs and goals. I collaborate with you to gather all relevant information, followed by research and concept creation.",
  },
  {
    id: "5",
    question: "What is your pricing structure?",
    answer:
      "My pricing depends on the type and complexity of the project. I offer both fixed rates and hourly rates, depending on the nature of the work.",
  },
...
export const socials = [
  {
    ...
    url: "https://github.com/prathamsingh19",
  },
  {
    id: "1",
    title: "Threads",
    icon: "/images/linkedpratham3.svg",
    url: "https://www.linkedin.com/in/prathamsingh19102003",
  },
  {
    id: "2",
    title: "Instagram",
    icon: "/images/socials/instagram.svg",
    url: "https://www.instagram.com/prathamsingh.__/",
  },
